      ...
      <li key={this.props.name} className="w3-list-item">
        <div className="w3-bar w3-left">
          ...
          <div className="w3-right">
            <button aria-label="re-add this package" className="w3-bar-item w3-large w3-hover-yellow w3-button">
              <i className="fas fa-check"></i>
            </button>
            <button aria-label="add a different amount" className="w3-bar-item w3-large w3-hover-yellow w3-button">
...
export class ShoppingView extends React.Component {
  render() {
    return(
      <>
        <Header inner="Shopping list" isLoggedIn={this.props.isLoggedIn} />
        <div className="w3-display">
          <div className="w3-display-middle w3-twothird w3-card w3-container">
